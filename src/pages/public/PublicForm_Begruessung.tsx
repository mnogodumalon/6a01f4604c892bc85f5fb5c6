...
const PROXY_BASE = '';
const APP_ID = '6a01f44fd41cb6e6da04a8fa';
...
export default function PublicFormBegruessung() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Begrüßung — Formular</h1>
        </div>
